			    ...
			    <nav class="navbar navbar-default bootsnav navbar-fixed dark no-background">
			        ...
			        <div class="container">
			            ...
			            <div class="navbar-header">
			                ...
			                <a class="navbar-brand" href="index.html">Edward Bun</a>
			            </div><!--/.navbar-header-->
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="header-text">
							<h2>HI <span>,</span> SAYA <br> EDWARD <br> BUN <span>.</span>   </h2>
							<p>Murid di SMK WIKRAMA BOGOR</p>
						</div><!--/.header-text-->
					</div><!--/.col-->
				</div><!-- /.row-->
			</div><!-- /.container-->
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="single-about-txt">
								...
								<p>
									Nama 				  : Edward Bun	<br>
									Tempat, Tanggal Lahir : Serang, 6 Oktober 2008<br>
									Umur                  : 15<br>
									Jurusan               : PPLG X-4</p>
								<div class="row">
									<div class="col-sm-4">
									...
									<div class="col-sm-4">
										<div class="single-about-add-info">
											<h3>website yang dulu</h3>
											<p>https://edwardbun.github.io/Portofolio.github.io/index.html</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="single-skill-content">
									...
									<div class="barWrapper">
										...
										<div class="single-progress-txt">
											<div class="progress ">
											   <div class="progress-bar" role="progressbar" aria-valuenow="20" aria-valuemin="10" aria-valuemax="100" style="">
										...
										<div class="row">
											<div class="col-md-5">
												<div class="experience-time text-right">
													<h2>2023 - Present</h2>
													<h3>Murid di SMK WIKRAMA BOGOR</h3>
												</div><!--/.experience-time-->
											</div><!--/.col-->
											<div class="col-md-offset-1 col-md-5">
												<div class="timeline">
													<div class="timeline-content">
														<p class="description">
															Mempelajari tentang HTML dan CSS dasar, Javascript Dasar Serta PHP dan Laravel
														</p>
							...
							<div class="single-contact-box">
								<div class="contact-adress">
									...
									<div class="contact-add-info">
										...
										<div class="single-contact-add-info">
											<h3>website yang dulu</h3>
											<p>https://bit.ly/Portofolio-Edward-Bun</p>
										</div>
									</div>
								</div><!--/.contact-adress-->
